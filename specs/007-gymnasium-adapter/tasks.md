...
- [ ] T001 Add the optional dependency surface to `pyproject.toml`:
...
- [ ] T002 [US1] Create `src/pra/anatomy/gymnasium_body.py`:
...
- [ ] T003 [US1] Same module: `GymnasiumBody(Body)` — wires
...
- [ ] T004 [P] [US1] Unit `tests/unit/test_gymnasium_world.py`
...
- [ ] T005 [P] [US1] Contract `tests/contract/test_gymnasium_contract.py`:
...
- [ ] T006 [US1] Integration `tests/integration/test_gymnasium_cartpole.py`
...
- [ ] T007 [US2] Unit (same file as T004): scripted env terminating
...
- [ ] T008 [US2] Integration (same file as T006): a real CartPole run
...
- [ ] T009 [US3] `examples/cartpole.py`: heavily commented single file —
...
- [ ] T010 [P] [US3] Integration (same file as T006): body ≡ world —
...
- [ ] T011 Stage the parallel-work doc edits (no shared files touched):
...
- [ ] T012 Quality gate, all green, none skipped:
