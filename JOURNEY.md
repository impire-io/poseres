...
decisions. **Brain seeding is now measured, not just named** (Chapter 44,
...
as a future feature). **And C1 is built to launch-ready** (Chapter
43): the world is a small self-hosted Minecraft server (owner's
