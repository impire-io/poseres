...
- [ ] T001 Create the `pra.examples` / `pra.examples.rover` subpackage
...
- [ ] T002 [US1] Geometry core in `src/pra/examples/rover/world.py`:
      ...
      (research R4, FR-011)
- [ ] T003 [US1] `RoverWorld` in `src/pra/examples/rover/world.py`:
...
- [ ] T004 [US1] Anatomy in `src/pra/examples/rover/world.py`:
...
- [ ] T005 [P] [US1] Unit `tests/unit/test_rover_world.py`: ray distances
      ...
      rejection
- [ ] T006 [P] [US1] Contract `tests/contract/test_rover_contract.py`:
...
- [ ] T007 [US1] Integration (`tests/integration/test_rover.py`, first
...
- [ ] T008 [US2] `RoverTelemetry` in `src/pra/examples/rover/viewer.py`:
...
- [ ] T009 [US2] `start_viewer(tap, port)` in the same module:
...
- [ ] T010 [US2] `src/pra/examples/rover/viewer.html`: single
...
- [ ] T011 [P] [US2] Contract additions in
...
- [ ] T012 [US2] Integration (second block): live-polling byte-identity —
...
- [ ] T013 [US3] `src/pra/examples/rover/cli.py`: argument surface per
      ...
      FR-008/009/011)
- [ ] T014 [US3] Integration (third block): `main([...])` with tiny
...
- [ ] T015 [P] Author `specs/006-rover-world/journey-chapter.md`
...
- [ ] T016 Run the real thing once end-to-end (default budgets, `--fps 0`,
      ...
      labeled
- [ ] T017 Quality gate: `./.venv/bin/ruff format --check . &&
