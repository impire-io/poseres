...
price-optimal dimensionality at every scale and budget (ch. [11](../04-JOURNEY/0011-the-threshold-diagnosis.md)–[14](../04-JOURNEY/0014-the-eighth-rule.md)), and every scaled acceptance criterion is measured — T3's amended
scaled form passes 24/24 (ch. [15](../04-JOURNEY/0015-t3-at-scale.md)–[16](../04-JOURNEY/0016-the-amendment-pays.md); the edge over learned persistence is
...
### A1. The seventh scale rule — ✅ done (ch. [11](../04-JOURNEY/0011-the-threshold-diagnosis.md)–[14](../04-JOURNEY/0014-the-eighth-rule.md))
...
([ch. 11](../04-JOURNEY/0011-the-threshold-diagnosis.md)); the diagnosis underneath found lifetime rot, and the eighth rule
(`weight_norm_cap`) eliminated it (ch. [13](../04-JOURNEY/0013-the-scorer-diagnosis.md)–[14](../04-JOURNEY/0014-the-eighth-rule.md)). All three are `pra-validate
...
### A2. T3's persistence clause at scale — ✅ done (ch. [15](../04-JOURNEY/0015-t3-at-scale.md)–[16](../04-JOURNEY/0016-the-amendment-pays.md))
...
### A3. The complexity ladder (worlds with ground truth) — ✅ done ([ch. 17](../04-JOURNEY/0017-the-complexity-ladder.md))
...
### A4. The drive blend for non-uniform worlds — ✅ done (ch. [18](../04-JOURNEY/0018-the-blend-dissolves.md) + [24](../04-JOURNEY/0024-the-frontier-drive.md))
The open curiosity/competence blend (camping risk), measured on the A3
ladder — in two acts. Act one ([ch. 18](../04-JOURNEY/0018-the-blend-dissolves.md)) **dissolved the blend question**:
both drives steer the lookahead with one shared novelty statistic, so no
blend surface existed. Act two ([ch. 24](../04-JOURNEY/0024-the-frontier-drive.md)) built the missing piece — the
...
at every horizon, at both noise dials** ([ch. 18](../04-JOURNEY/0018-the-blend-dissolves.md)'s mild-noise equivocation
...
Phase C depends on. The platform successors added 2026-07-18 (
[ch. 27](../04-JOURNEY/0027-the-platform-successors.md)) were sequenced strictly B6 → B7 — one transport, built once —
and both landed the same day: **B6**, the external bus backend ([ch. 28](../04-JOURNEY/0028-nats-at-the-seams.md)),
and **B7**, the dashboard that consumes its subjects ([ch. 29](../04-JOURNEY/0029-one-face-for-any-brain.md)).

### B1. The watchable world (`examples/` + live viewer) — ✅ done ([ch. 20](../04-JOURNEY/0020-the-watchable-rover-world.md))
...
### B2. The Gymnasium adapter — ✅ done ([ch. 19](../04-JOURNEY/0019-the-gymnasium-adapter.md))
...
### B3. Continuous operation (no `reset()`) — ✅ done ([ch. 21](../04-JOURNEY/0021-continuous-operation.md))
...
### B4. Multi-stream experience (N worlds, one brain) — ✅ done ([ch. 22](../04-JOURNEY/0022-multi-stream.md))
...
### B5. Snapshot completeness — ✅ done ([ch. 23](../04-JOURNEY/0023-snapshot-completeness.md))
...
### B6. External bus backend (NATS/JetStream) — ✅ done ([ch. 28](../04-JOURNEY/0028-nats-at-the-seams.md))
The next link in the distributed-operation chain (A1 → B4 → **this** →
multi-machine). The framing that was considered and rejected (
[ch. 27](../04-JOURNEY/0027-the-platform-successors.md)): NATS *underneath* the engine. The fast loop is a batched
...
### B7. Web dashboard / monitor — ✅ done ([ch. 29](../04-JOURNEY/0029-one-face-for-any-brain.md))
...
*Platform half DONE (feature 027, [ch. 43](../04-JOURNEY/0043-the-brain-moves-into-minecraft.md)):* the pra-mc/1
...
mid-run body growth.
*Platform landed (feature 013, [ch. 26](../04-JOURNEY/0026-the-ros2-adapter.md)):* the **ROS2 adapter**
...
build uses.
*Showcase gate sharpened (2026-07-18, [ch. 27](../04-JOURNEY/0027-the-platform-successors.md)):* real sensors
carry noisy channels — the Gazebo lidar already NaN-poisoned a run
([ch. 26](../04-JOURNEY/0026-the-ros2-adapter.md)), and channel static at sensor amplitude collapses selection
([ch. 25](../04-JOURNEY/0025-channel-noise.md)). **Learned channel weighting** is therefore a de facto research
...
non-goals list (see [Chapter 10](../04-JOURNEY/0010-the-product-thesis.md)): they shape design decisions today
...
- **An alternative paradigm of intelligence.** PRA's long-range claim is
  ...
  amended 2026-07-19 — [ch. 42](../04-JOURNEY/0042-the-vision-re-broadened.md)). When the research matures, this claim demands
...
- **Language as a learnable world** (added 2026-07-19, reversing the
  2026-07-08 exclusion — [ch. 42](../04-JOURNEY/0042-the-vision-re-broadened.md)). The founding bet
  ...
  *predictable*), per-action transition slices vs realistic vocabularies
  ...
  unbounded sequences. Pre-registered prediction in [ch. 42](../04-JOURNEY/0042-the-vision-re-broadened.md). No language
  showcase before the gate reads — the constitution applies.
- **Seeding / compounding intelligence** — ✅ **measured (feature 028,
  [ch. 44](../04-JOURNEY/0044-brain-seeding.md), 2026-07-20); all three bars PASS.** The claim held: a
...
gated research question (the 2026-07-08 exclusion reversed —
[ch. 42](../04-JOURNEY/0042-the-vision-re-broadened.md)).
