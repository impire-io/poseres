...
named new open problem: channel-noise robustness — now diagnosed, Chapter
25: a three-leg mechanism with the remedy named **learned channel
weighting** and honestly deferred). **Phase A closes
...
24). Open research, in priority order: **learned channel weighting**
(the channel-noise remedy, named and sized by Chapter 25), frontier-vs-competence on worlds where camping
