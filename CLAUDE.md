...
`specs/029-brain-telemetry-dashboard/plan.md`
<!-- SPECKIT END -->

Read `AGENTS.md` for the durable working rules of this repository, and
`hq/04-JOURNEY/README.md` for the narrative of how the project got here.
`hq/00-GENESIS/` holds the vision, constitution, and working agreement every
