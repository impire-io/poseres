...
change. Open research, in priority order: **place-indexed long-horizon
error memory** (the representation predictive LP needs; the
camping-costs worlds and their frozen grid are its testbed), the
