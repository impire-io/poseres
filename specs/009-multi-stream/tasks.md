...
- [x] T001 `Config.n_streams` (default 1) + validation incl. the B5 guard
...
- [x] T002 [US1] Engine K-stream branch in `src/pra/core/engine.py`:
      ...
      K=1 path untouched
- [x] T003 [US1] Integration `tests/integration/test_multistream.py`:
...
- [x] T004 [US1] Unit `tests/unit/test_multistream.py`: validation
...
- [x] T005 [US2] Placement tests: consolidation positions (total
...
- [x] T006 [US3] Run the pre-registered exit protocol (R5): reference
...
- [x] T007 [P] Propagate: Doc 07 `n_streams` entry; PRA-01 §6.6 note;
      GETTING-STARTED paragraph; ROADMAP B4; JOURNEY chapter + "Where
      things stand"; memory
- [x] T008 Quality gate → merge to main → push
