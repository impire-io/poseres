...
Open research, in priority order: fully
*predictive* LP (a per-candidate error model; the camping-costs worlds
are its testbed and Chapter 31's numbers its baseline), the
