...
named new open problem: **channel-noise robustness**). Open research, in
priority order: the curiosity/competence blend on the L1 rung (A4 — now
unblocked, with per-seed random-policy occupancy baselines in hand),
channel-noise robustness (a noise-amplitude dose–response is the first
experiment), predicted-LP lookahead, the elect-gating question, snapshot
