"""One-time provisioning for the partial-gap-world rig world.

The N1 probe kit's declared setup, verbatim, retargeted at the
pgw1-minecraft container: difficulty normal, mob spawning off, spawn
...
Usage: python provision.py   (container pgw1-minecraft must be up)
"""
